...
//got from stack overflow for rounding
...
public class Blackjack {
    ...
    public static void main(String[] args) {
        int gameNumber = 1;
        double percentage;
        //stack overflow https://stackoverflow.com/questions/22186778/using-math-round-to-round-to-one-decimal-place
        ...
        while (!gameOver) {
            ...
            //select option two-player holding
               ...
               //debugging
                ...
                if(dealerDeck<=21) {
                    ...
                    //not equal to 21 and not equal to playerDeck
                    else {
                ...
                else if(dealerDeck>21 && dealerDeck<=26){
                    System.out.println("");
                    System.out.println("Dealer's hand: " + dealerDeck);
                    System.out.println("Your hand is: " + playerDeck);
                    System.out.println("");
            ...
            //select option three
                ...
                //stack overflow https://stackoverflow.com/questions/11701399/round-up-to-2-decimal-places-in-java
